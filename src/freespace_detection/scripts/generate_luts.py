...
# 카메라 내부 파라미터 (캘리브레이션 usb_webcam.yaml 기준 축소 보정)
fx = 258.5994        # 수평 초점 거리 (517.1989 * 320 / 640)
cx = 159.4597        # 주점 x (318.9193 * 320 / 640)
fy = 273.6966        # 수직 초점 거리 (513.1812 * 256 / 480)
cy = 134.6184        # 주점 y (252.4095 * 256 / 480)
